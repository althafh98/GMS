...
namespace My_Project {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_StockDataTable : global::System.Data.TypedTableBase<tbl_StockRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tbl_StockRow Addtbl_StockRow(string ProductName, int ProductQuantity, string ProductUnit) {
        ...
        public partial class tbl_StockRow : global::System.Data.DataRow {
            ...
            public int ProductQuantity {
                get {
                    try {
                        return ((int)(this[this.tabletbl_Stock.ProductQuantityColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ProductQuantity\' in table \'tbl_Stock\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbl_Stock.ProductQuantityColumn] = value;
                }
            }
            ...
            public string ProductUnit {
                get {
                    try {
                        return ((string)(this[this.tabletbl_Stock.ProductUnitColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ProductUnit\' in table \'tbl_Stock\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbl_Stock.ProductUnitColumn] = value;
                }
            }
            ...
            public bool IsProductQuantityNull() {
                return this.IsNull(this.tabletbl_Stock.ProductQuantityColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetProductQuantityNull() {
                this[this.tabletbl_Stock.ProductQuantityColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsProductUnitNull() {
                return this.IsNull(this.tabletbl_Stock.ProductUnitColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetProductUnitNull() {
                this[this.tabletbl_Stock.ProductUnitColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace My_Project.DatabaseDataSetTableAdapters {
    ...
    public partial class tbl_StockTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbl_Stock] WHERE (([ID] = @Original_ID) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_ProductQuantity = 1 AND [ProductQuantity] IS NULL) OR ([ProductQuantity] = @Original_ProductQuantity)) AND ((@IsNull_ProductUnit = 1 AND [ProductUnit] IS NULL) OR ([ProductUnit] = @Original_ProductUnit)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ProductUnit", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductUnit", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbl_Stock] ([ProductName], [ProductQuantity], [ProductUnit]) V" +
                "ALUES (@ProductName, @ProductQuantity, @ProductUnit);\r\nSELECT ID, ProductName, P" +
                "roductQuantity, ProductUnit FROM tbl_Stock WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductUnit", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductUnit", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_Stock] SET [ProductName] = @ProductName, [ProductQuantity] = @ProductQuantity, [ProductUnit] = @ProductUnit WHERE (([ID] = @Original_ID) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_ProductQuantity = 1 AND [ProductQuantity] IS NULL) OR ([ProductQuantity] = @Original_ProductQuantity)) AND ((@IsNull_ProductUnit = 1 AND [ProductUnit] IS NULL) OR ([ProductUnit] = @Original_ProductUnit)));
SELECT ID, ProductName, ProductQuantity, ProductUnit FROM tbl_Stock WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductUnit", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductUnit", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ProductUnit", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductUnit", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::My_Project.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, ProductName, ProductQuantity, ProductUnit FROM dbo.tbl_Stock";
        ...
        public virtual int Fill(DatabaseDataSet.tbl_StockDataTable dataTable) {
        ...
        public virtual DatabaseDataSet.tbl_StockDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet.tbl_StockDataTable dataTable = new DatabaseDataSet.tbl_StockDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet.tbl_StockDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_ProductName, global::System.Nullable<int> Original_ProductQuantity, string Original_ProductUnit) {
            ...
            if ((Original_ProductUnit == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_ProductUnit));
            }
        ...
        public virtual int Insert(string ProductName, global::System.Nullable<int> ProductQuantity, string ProductUnit) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, global::System.Nullable<int> ProductQuantity, string ProductUnit, int Original_ID, string Original_ProductName, global::System.Nullable<int> Original_ProductQuantity, string Original_ProductUnit, int ID) {
            if ((ProductName == null)) {
            ...
            if ((Original_ProductUnit == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_ProductUnit));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, global::System.Nullable<int> ProductQuantity, string ProductUnit, int Original_ID, string Original_ProductName, global::System.Nullable<int> Original_ProductQuantity, string Original_ProductUnit) {
            return this.Update(ProductName, ProductQuantity, ProductUnit, Original_ID, Original_ProductName, Original_ProductQuantity, Original_ProductUnit, Original_ID);
        }
    }
